...
@push('css')
    <link rel="stylesheet" href="{{ url('assets/datepicker/bootstrap-datepicker.min.css') }}">
@endpush
                    ...
                    <form method="post" action="{{ route('book.store') }}" enctype="multipart/form-data">
                        ...
                        <div>
                            <div class="form-group col-md-8">
                                ...
                                <input required type="number" class="form-control" name="no_buku" value="<?= $NoBuku[0]->no_buku + 1; ?>"/>
                            </div>
                        </div>
                        ...
                        <div class="form-group col-md-8">
                            ...
                            <div id="ketBuku">
                                <div class="form-group col-md-8">
                                    ...
                                    <textarea name="keterangan_buku" required v-model='message' @keyup='charCount()' class="form-control" rows="7" placeholder="Maks. 500 Karakter"></textarea>
...
<script src=" {{ url('assets/datepicker/bootstrap-datepicker.min.js') }} "></script>
